...
// MY SERVER
Moralis.initialize("deyKEFD8O9PqihT4jye07LKf69831RfxHH4iLGPC");
...
if (Moralis.User.current() == null && window.location.href != homepage) {
    ...
    window.location.href = "https://sidharthweb3.github.io/project2/index.html";
}
...
login = async () => {
    await Moralis.Web3.authenticate()
        .then(async function (user) {
            ...
            window.location.href = "https://sidharthweb3.github.io/project2/dashboard.html";
        })
}
...
getTransactions = async () => {
    ...
    const options = { chain: 'eth', address: "0x3401ea5a8d91c5e3944962c0148b08ac4a77f153" };
    ...
    if (ethTokens.length > 0) {
        ...
        ethTokens.forEach((e, i) => {
            let content = `
                  ...
                  <td>${e.decimals}</td>
                  <td>${e.token_address}</td>
                  <td><button class="btn btn-primary transfer-button col-md-12" data-decimals="${e.decimals
